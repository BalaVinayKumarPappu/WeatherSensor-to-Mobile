...
cs_2(6, "actual"),
cs_3(5, "sunny");
static const unsigned char module_checksum[] = { 0xb6, 0xd2, 0x77, 0xb1, 0x01, 0x06, 0x3a, 0x20, 0x76, 0xd5, 0x9e, 0x63, 0x15, 0xa9, 0x13, 0x48 };
...
static weatherRequest_template template_FrankfurtWeatherRequest;
const weatherRequest_template& FrankfurtWeatherRequest = template_FrankfurtWeatherRequest;
...
static weatherResponse_template template_FrankfurtWeatherResponse;
const weatherResponse_template& FrankfurtWeatherResponse = template_FrankfurtWeatherResponse;
...
weatherRequest_template officeFrankfurtRequestParam(const CHARSTRING& reqloc)
{
weatherRequest_template ret_val;
ret_val.location() = reqloc;
ret_val.date() = cs_1;
ret_val.kind() = cs_2;
return ret_val;
}

weatherResponse_template serviceFrankfurtResponseParam(const CHARSTRING& resloc)
{
weatherResponse_template ret_val;
ret_val.location() = resloc;
ret_val.date() = cs_1;
ret_val.kind() = cs_2;
ret_val.temperature() = 20;
ret_val.windVelocity() = 15;
ret_val.conditions() = cs_3;
return ret_val;
}

void weather__Office()
{
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 71 */
{
tmp_2:
...
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 72 */
tmp_2_alt_flag_0 = MTCType1_component_weatherOffice.receive(FrankfurtWeatherResponse, NULL, any_compref, NULL, NULL);
if (tmp_2_alt_flag_0 == ALT_YES) {
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 73 */
TTCN_Runtime::setverdict(PASS,(TTCN_Logger::begin_event_log2str(),TTCN_Logger::log_event_str("expected response received "),FrankfurtWeatherResponse.log(),TTCN_Logger::end_event_log2str()));
break;
}
}
if (tmp_2_alt_flag_1 == ALT_MAYBE) {
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 75 */
tmp_2_alt_flag_1 = MTCType1_component_weatherOffice.receive(any_compref, NULL, NULL);
if (tmp_2_alt_flag_1 == ALT_YES) {
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 76 */
...
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 71 */
if (tmp_2_alt_flag_0 == ALT_NO && tmp_2_alt_flag_1 == ALT_NO && tmp_2_default_flag == ALT_NO) TTCN_error("None of the branches can be chosen in the alt statement in file C:\\Users\\Vinnu\\workspace\\WeatherSensor-to-Mobile\\src\\WeatherSensor_to_Mobile.ttcn between lines 71 and 78.");
...
{
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 82 */
{
tmp_3:
...
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 83 */
tmp_3_alt_flag_0 = MTCType2_component_weatherService.receive(FrankfurtWeatherRequest, NULL, any_compref, NULL, NULL);
if (tmp_3_alt_flag_0 == ALT_YES) {
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 84 */
try {
TTCN_Logger::begin_event(TTCN_USER);
TTCN_Logger::log_event_str("REQUEST ACCEPTED");
FrankfurtWeatherRequest.log();
TTCN_Logger::end_event();
} catch (...) {
TTCN_Logger::finish_event();
throw;
}
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 85 */
MTCType2_component_weatherService.send(serviceFrankfurtResponse);
{
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 86 */
...
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 89 */
tmp_3_alt_flag_1 = MTCType2_component_weatherService.receive(any_compref, NULL, NULL);
if (tmp_3_alt_flag_1 == ALT_YES) {
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 90 */
MTCType2_component_weatherService.send(serviceFrankfurtResponse);
{
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 91 */
TTCN_Runtime::setverdict(FAIL);
}
break;
}
...
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 82 */
if (tmp_3_alt_flag_0 == ALT_NO && tmp_3_alt_flag_1 == ALT_NO && tmp_3_default_flag == ALT_NO) TTCN_error("None of the branches can be chosen in the alt statement in file C:\\Users\\Vinnu\\workspace\\WeatherSensor-to-Mobile\\src\\WeatherSensor_to_Mobile.ttcn between lines 82 and 94.");
TTCN_Snapshot::take_new(TRUE);
}
}
}
...
verdicttype testcase_testWeather(const weatherRequest_template& officeFrankfurtRequest, const weatherResponse_template& serviceFrankfurtResponse, boolean has_timer, double timer_value)
{
...
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 98 */
COMPONENT service(TTCN_Runtime::create_component("WeatherSensor_to_Mobile", "MTCType2", NULL, NULL, FALSE));
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 100 */
...
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 101 */
start_weather__Service(service, serviceFrankfurtResponse);
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 102 */
MTCType1_component_weatherOffice.send(officeFrankfurtRequest);
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 103 */
weather__Office();
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 104 */
{
tmp_4:
...
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 104 */
if (alt_flag == ALT_NO && default_flag == ALT_NO) TTCN_error("Stand-alone done statement failed in file C:\\Users\\Vinnu\\workspace\\WeatherSensor-to-Mobile\\src\\WeatherSensor_to_Mobile.ttcn, line 104.");
TTCN_Snapshot::take_new(TRUE);
}
}
...
static void post_init_module()
{
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 11 */
template_FrankfurtWeatherRequest.location() = cs_0;
template_FrankfurtWeatherRequest.date() = cs_1;
template_FrankfurtWeatherRequest.kind() = cs_2;
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 34 */
template_FrankfurtWeatherResponse.location() = cs_0;
template_FrankfurtWeatherResponse.date() = cs_1;
template_FrankfurtWeatherResponse.kind() = cs_2;
{
INTEGER_template& tmp_0 = template_FrankfurtWeatherResponse.temperature();
tmp_0.set_type(VALUE_RANGE);
tmp_0.set_min(15);
tmp_0.set_max(30);
}
{
INTEGER_template& tmp_1 = template_FrankfurtWeatherResponse.windVelocity();
tmp_1.set_type(VALUE_RANGE);
tmp_1.set_min(0);
tmp_1.set_max(20);
}
template_FrankfurtWeatherResponse.conditions() = cs_3;
}
...
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 109 */
VALUE_ARRAY<CHARSTRING, 5, 0> newReqlocation;
newReqlocation[0] = cs_4;
newReqlocation[1] = cs_0;
newReqlocation[2] = cs_0;
newReqlocation[3] = cs_5;
newReqlocation[4] = cs_6;
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 111 */
INTEGER i;
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 111 */
INTEGER incr(5);
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 113 */
VALUE_ARRAY<CHARSTRING, 5, 0> newReslocation;
newReslocation[0] = cs_0;
newReslocation[1] = cs_0;
newReslocation[2] = cs_7;
newReslocation[3] = cs_5;
newReslocation[4] = cs_6;
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 118 */
i = 0;
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 118 */
for ( ; ; ) {
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 118 */
if (!(i < incr)) break;
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 119 */
testcase_testWeather(officeFrankfurtRequestParam(const_cast< const VALUE_ARRAY<CHARSTRING, 5, 0>&>(newReqlocation)[i]), serviceFrankfurtResponseParam(const_cast< const VALUE_ARRAY<CHARSTRING, 5, 0>&>(newReslocation)[i]), FALSE, 0.0);
/* C:\Users\Vinnu\workspace\WeatherSensor-to-Mobile\src\WeatherSensor_to_Mobile.ttcn, line 118 */
{
INTEGER tmp_6;
++i;
