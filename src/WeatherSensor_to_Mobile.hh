...
extern weatherRequest_template officeFrankfurtRequestParam(const CHARSTRING& reqloc);
extern weatherResponse_template serviceFrankfurtResponseParam(const CHARSTRING& resloc);
...
extern verdicttype testcase_testWeather(const weatherRequest_template& officeFrankfurtRequest, const weatherResponse_template& serviceFrankfurtResponse, boolean has_timer, double timer_value);
...
extern const weatherRequest_template& FrankfurtWeatherRequest;
...
extern const weatherResponse_template& FrankfurtWeatherResponse;
