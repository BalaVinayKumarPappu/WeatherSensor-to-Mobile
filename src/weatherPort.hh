...
#ifndef weatherPort_HH
#define weatherPort_HH

#include "WeatherSensor_to_Mobile.hh"

namespace WeatherSensor__to__Mobile {

class weatherPort : public weatherPort_BASE {
public:
	weatherPort(const char *par_port_name = NULL);
	~weatherPort();
...
protected:
	...
	void outgoing_send(const weatherRequest& send_par);
};
